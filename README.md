...
| getOptions     | <em>function(this: *, ...<a href="#type-context" title="A context instance to pass to the tests.">Context</a>): [!child_process.ForkOptions](#type-child_processforkoptions)</em>                                                                                    | The function to get options for the fork, such as `ENV` and `cwd`, based on contexts. The `this` context is set to the passed properties.                                                                        | -       |
