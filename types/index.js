...
/* typal node_modules/assert-throws/types/index.xml namespace */
/**
...
/* typal node_modules/@zoroaster/fork/types/index.xml namespace */
/**
 ...
 * @prop {(this: *, arg0: !Array<string>, ...args: _contextTesting.Context[]) => !(Array<string>|Promise<!Array<string>>)} [getArgs] The function to get arguments to pass the fork based on the parsed mask input and contexts. The `this` context is set to the passed properties.
 * @prop {(this: *, ...args: _contextTesting.Context[]) => !child_process.ForkOptions} [getOptions] The function to get options for the fork, such as `ENV` and `cwd`, based on contexts. The `this` context is set to the passed properties.
...
/* typal node_modules/@zoroaster/fork/types/context.xml namespace */
/**
...
/* typal types/index.xml namespace ignore:_assertThrows.Config,_contextTesting.Context,_contextTesting.ForkConfig  */
/**
 ...
 * @prop {(arg0: *) => string} [mapActual] The function to get a value to test against `expected` mask property from results returned by `getResults`.
 * @prop {(arg0: *, arg1: !Object<string, *>) => (!Promise|undefined)} [assertResults] A possibly async function containing any addition assertions on the results. The results from `getResults` and a map of expected values extracted from the mask's result (where `jsonProps` are parsed into JS objects) will be passed as arguments.
